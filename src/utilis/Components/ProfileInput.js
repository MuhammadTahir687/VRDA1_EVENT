            ...
            <View style={styles.pi1container}>
                ...
                <View style={styles.p1textview}>
                    <Text style={[styles.pi1text,{color:colors.profilrtext}]}>{text1}</Text>
                     <TextInput
                        style={[{flex:1,borderBottomWidth:1,color:(editable1==false)?"white":colors.profilrtext,borderColor:colors.profilrtext,backgroundColor:(editable1==false)?colors.registerbtn:"transparent"}]}
